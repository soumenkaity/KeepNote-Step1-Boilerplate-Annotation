...
public class NoteController {
	...
	*/
	...
	public String addNote(ModelMap modelMap,
		...
		if(noteId == null){
			modelMap.addAttribute("errorID","ID can't be empty");
			modelMap.addAttribute("notes", noteRepository.getAllNotes());
			return "index";
		}
		if(noteTitle.isEmpty()){
			modelMap.addAttribute("errorTitle", "Title can't be empty");
			modelMap.addAttribute("notes", noteRepository.getAllNotes());
			return "index";
		}
		if(noteContent.isEmpty()){
			modelMap.addAttribute("errorContent", "Content can't be empty");
			modelMap.addAttribute("notes", noteRepository.getAllNotes());
			return "index";
		}
		if(noteStatus.isEmpty()){
			modelMap.addAttribute("errorStatus", "Status can't be empty");
			modelMap.addAttribute("notes", noteRepository.getAllNotes());
			return "index";
		}
		if(noteRepository.exists(noteId)){
			modelMap.addAttribute("error", "NoteID already exists");
		}
		else {
			Note note = getNote();
